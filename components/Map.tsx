...
// Import MarkerClusterGroup as a default export
		...
		>
			...
			<MarkerClusterGroup>
				{accidents?.map((accident) => {
					...
					const { point_x, point_y, primary_rd, secondary_rd, city } = location;

					// Skip invalid coordinates
					if (!point_x || !point_y) return null;

					return (
						<Marker key={case_id} position={[point_y, point_x]}>
							<Popup>
								<strong>Date:</strong>{" "}
								...
								<br />
								<strong>Number Killed:</strong> {severity.number_killed || 0}
								<br />
								<strong>Number Injured:</strong> {severity.number_injured || 0}
								<br />
