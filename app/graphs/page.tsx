        ...
        <div className="container mx-auto">
			<div className="flex items-center font-mono">
				...
				<form
				 ...
				 onSubmit={countySubmit} className="w-1/2">
				...
				<button className="block w-48 rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" type="submit">
					Submit</button>
				</form>
			</div>
			<br/>
			<div className="columns-2">
					<div>
					<h1 className="flex justify-center text-2xl font-bold mb2">Accidents by Year</h1>
					{countyByYearData.length > 0 ? (
						
						<AccidentsByYear data={countyByYearData.map((data) =>{
					...
					<div>
					<h1 className="flex justify-center text-2xl font-bold mb2">Motorcycle Accidents</h1>

					{countyByYearData.length > 0 ? (
						
						<AccidentsByYear data={countyByYearData.map((data) =>{
						return{year: data.year, total:data.data.motorcycle_accidents}
						})}></AccidentsByYear>
					...
					<div>
					<h1 className="flex justify-center text-2xl font-bold mb2">Traffic Injuries</h1>
					{countyByYearData.length > 0 ? (
					...
					<div>
					<h1 className="flex justify-center text-2xl font-bold mb2">Pedestrians Involved</h1>

					{countyByYearData.length > 0 ? (
						
						<AccidentsByYear data={countyByYearData.map((data) =>{
						return{year: data.year, total:data.data.pedestrian_accidents}
						})}></AccidentsByYear>
